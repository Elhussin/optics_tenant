...
import { Stock, StockTransfer } from "@/src/features/inventory/types";
    ...
    stocks.forEach((s) => {
      if (s.branch && !branchMap.has(s.branch)) {
        branchMap.set(s.branch, {
          id: s.branch,
          name: s.branch_name || `فرع ${s.branch}`,
        });
      }
    });
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-secondary mt-1">
              متابعة المخزون والحركات والتحويلات
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-secondary">إجمالي المنتجات</p>
          ...
          >
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-secondary">مخزون منخفض</p>
          ...
          >
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-secondary">نفذ المخزون</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-secondary">تحويلات معلقة</p>
              ...
              <CardContent>
                {stocksLoading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-secondary">لا توجد نتائج</p>
                  </div>
                ) : (
          ...
          <TabsContent value="transfers">
            <Card>
              <CardHeader>
                ...
                <CardDescription>قائمة التحويلات بين الفروع</CardDescription>
              </CardHeader>
              <CardContent>
                {pendingTransfers?.length === 0 ? (
                  <div className="text-center py-12">
                    <ArrowLeftRight className="w-16 h-16 mx-auto text-gray-300 mb-4" />
                    <p className="text-secondary mb-4">لا توجد تحويلات معلقة</p>
                    <Link href="/dashboard/inventory/transfers/create">
