      ...
      >
        ...
        >
          <Link
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl font-medium transition-transform active:scale-95 shadow-lg shadow-red-600/25 w-full"
          >
            <RefreshCw size={18} />
            {t('button')}
          </Link>
