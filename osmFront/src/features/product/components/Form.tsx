...
export const RenderForm = ({ filteredConfig, selectedType, control, register, errors, setValue, watch, data, setShowModal, setEntity, setCurrentFieldName }: RenderFormProps) => {
    return (
