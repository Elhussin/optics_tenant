...
export const formsConfig: Record<string, FormConfig> = {
  ...
  'payments': {
    ...
    fields: ["amount", "transaction_id", "client", "status","method", "direction", "created_at", "updated_at", "method", "currency"],
    detailsField: ["amount", "transaction_id", "status", "client", "created_at", "updated_at", "method", "currency"],
    isViewOnly: true
  },
  // 'paypal-cancel': {
  //   schemaName: 'PaypalRequest',
  //   listAlias: 'tenants_paypal_cancel_retrieve',
  //   fields: ["client", "plan"],
  //   detailsField: ["client", "plan", "created_at", "updated_at", "is_active"],
  //   isViewOnly: true
  // },
  //   'paypal-execute': {
  //   schemaName: 'PaypalRequest',
  //   listAlias: 'tenants_paypal_execute_create',
  //   fields: ["client", "plan"],
  //   detailsField: ["client", "plan", "created_at", "updated_at", "is_active"],
  //   isViewOnly: true
  // },
 ...
 'contacts': {
  ...
  "brands": {
    ...
    fields: ["name", "email", "phone"],
    detailsField: ["name", "country", "website", "description", "logo", "is_active","product_type"],
  },
  "categories": {
