...
export const BasicVariantConfig: ProductConfigType[] = [
  ...
  },
  {
    ...
    role: "all",
    filter: "Minimum Selling Price",
    subFilter: "",
    title: "Minimum allowable price floor",
    entityName: "attribute-values",
    fieldName: "attribute_name",
    type: "text",
  ...
  },
  {
    ...
    filter: "Barcode",
    subFilter: "",
    title: "Numeric POS Barcode",
    entityName: "attribute-values",
    fieldName: "attribute_name",
    type: "text",
    placeholder: "Leave empty for auto-generated barcode...",
    required: false,
  },
  {
  ...
  },
  {
    ...
    filter: "Tax Category",
    subFilter: "",
    title: "Tax classification for VAT",
    entityName: "tax_category",
    fieldName: "label",
    type: "select",
    options: [
      { label: "Standard (15%)", value: "standard" },
      { label: "Zero-Rated (0% Medical)", value: "zero_rated" },
