...
export const SearchFilterForm = ({ fields, setFilters }: Props) => {
  ...
  // Build initial
  // 
  // form state from URL query (ignore pagination params)
  ...
  return (
    <AnimatePresence>
      {isSearchVisible && (
        ...
        >
          <form key={resetKey} className="p-5 bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800" onSubmit={handleSubmit}>
