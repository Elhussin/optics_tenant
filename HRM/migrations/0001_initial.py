    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'admin'), ('BRANCH_MANAGER', 'branch_manager'), ('TECHNICIAN', 'technician'), ('SALESPERSON', 'salesperson'), ('ACCOUNTANT', 'accountant'), ('INVENTORY_MANAGER', 'inventory_manager'), ('RECEPTIONIST', 'receptionist'), ('CRM', 'crm')], default='RECEPTIONIST', max_length=50)),
