...
# Import from the original models.py (now accounting_base.py equivalent)
# These were defined in the existing models.py file
...
class Transaction(models.Model):
    ...
    amount = MoneyField(max_digits=10, decimal_places=2,
                        default_currency='USD', currency_field_name='amount_currency')
    transaction_type = models.CharField(
        max_length=7, choices=[('income', 'Income'), ('expense', 'Expense')])
...
class JournalEntry(models.Model):
    """Legacy Journal Entry - kept for compatibility"""
