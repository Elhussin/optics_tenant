    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='values', to='products.attributes')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='productvariant',
            name='product_type',
            field=models.ForeignKey(limit_choices_to={'attribute_id__name': 'Product Type'}, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_product_type', to='products.attributevalue'),
        ),
        migrations.AddField(
            model_name='productvariant',
            name='warranty',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Active')),
                ('is_deleted', models.BooleanField(default=False, verbose_name='Deleted')),
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attribute_set', to='products.attributes')),
                ...
                ('variant_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='extravariantattribute_set', to='products.attributes')),
            ],
        ),
        migrations.CreateModel(
            name='FlexiblePrice',
            fields=[
                ...
                ('branch_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='branches.branch')),
                ('customer_group_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.customergroup')),
                ('customer_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.customer')),
                ('variant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_rules', to='products.productvariant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='products.productvariant')),
            ],
            options={
                'ordering': ['order', 'id'],
            },
